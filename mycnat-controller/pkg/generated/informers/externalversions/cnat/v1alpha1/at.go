...
import (
	...
	v1alpha1 "github.com/ypxns/k8s_component/mycnat-controller/pkg/generated/listers/cnat/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MycnatV1alpha1().Ats(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MycnatV1alpha1().Ats(namespace).Watch(context.TODO(), options)
			},
		},
		&cnatv1alpha1.At{},
		resyncPeriod,
